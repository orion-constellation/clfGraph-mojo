...
# Initialize W&B
wandb.init(project="classification-baselines", name="Logistic_Regression_model")
...
# Utility function to train classification models
def train_classification_models(clf_models: defaultdict[str, BaseEstimator], X_train, y_train, X_test, y_test, params: dict):
...
Returns:
None'''
def train_clustering_models(cluster_models: defaultdict[str, BaseEstimator], X_train, params: dict):
...
train_classification_models(clf_models, X_train, y_train, X_test, y_test, params)
train_clustering_models(cluster_models, X_train, params)